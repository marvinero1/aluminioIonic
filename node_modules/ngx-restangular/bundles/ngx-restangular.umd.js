(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),exports, require('@angular/core'), require('@angular/common/http'), require('lodash'), require('core-js/features/object'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-restangular', ['@angular/core','@angular/common/http','exports', '@angular/core', '@angular/common/http', 'lodash', 'core-js/features/object', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common.http,global['ngx-restangular'] = {}, global.ng.core, global.ng.common.http, global.lodash, global.object, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, http, lodash, object, rxjs, operators) { 'use strict';
...
RestangularHttp.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RestangularHttp, factory: function (t) { return RestangularHttp.ɵfac(t); } });
...
Restangular.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Restangular, factory: function (t) { return Restangular.ɵfac(t); } });
...
RestangularModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function RestangularModule_Factory(t) { return new (t || RestangularModule)(ɵngcc0.ɵɵinject(RestangularModule, 12)); }, providers: [RestangularHttp, Restangular], imports: [[http.HttpClientModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RestangularModule, { imports: [ɵngcc1.HttpClientModule] }); })();
