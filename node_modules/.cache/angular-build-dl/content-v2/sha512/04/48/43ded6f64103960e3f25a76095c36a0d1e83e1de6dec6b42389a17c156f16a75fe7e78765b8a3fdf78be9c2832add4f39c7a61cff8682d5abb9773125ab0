...
/* harmony import */ var _productos_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./productos.page */ "./src/app/productos/productos.page.ts");
...
let ProductosPage = class ProductosPage {
    constructor(api, router, menuCtrl) {
        this.api = api;
        this.router = router;
