      ...
      var MisCortesPage = /*#__PURE__*/function () {
        ...
        _createClass(MisCortesPage, [{
          ...
          value: function goWeb(id) {
            var browser = this.iab.create('https://altools.es/hojaCalculo/' + id);
            browser.on('loadstop').subscribe(function (event) {
              browser.insertCSS({
                code: "body{color: red;"
              });
            });
            browser.close(); // this.router.navigateByUrl('https://altools.es/api/hojaCalculo/'+ id);
